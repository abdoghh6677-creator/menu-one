-- =====================================================
-- دالة إنشاء مطعم تلقائياً بدون مراجعة
-- Auto-create restaurant without admin review
-- =====================================================
...
DECLARE
    ...
    v_user_id UUID;
BEGIN
    -- التحقق من عدم وجود مطعم بنفس الاسم أو البريد الإلكتروني
    ...
    -- حفظ طلب التسجيل للأرشفة (اختياري)
...
-- دالة مساعدة لإنشاء كلمة مرور مؤقتة
...
DO $$
BEGIN
    RAISE NOTICE '✓ تم إنشاء دالة التسجيل التلقائي للمطاعم!';
    RAISE NOTICE '✓ المطاعم يمكنها الآن التسجيل مباشرة بدون مراجعة!';
END $$;
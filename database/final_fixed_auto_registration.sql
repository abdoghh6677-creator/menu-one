-- =====================================================
-- نظام التسجيل التلقائي للمطاعم - النسخة النهائية المُصححة
-- Auto Restaurant Registration System - Final Fixed Version
-- =====================================================

-- 1. دالة إنشاء slug (بدون unaccent)
...
-- 3. الدالة الرئيسية للتسجيل التلقائي
...
DO $$
BEGIN
    RAISE NOTICE '✅ تم إنشاء نظام التسجيل التلقائي بنجاح!';
    RAISE NOTICE '✅ تم إصلاح مشكلة unaccent - النظام يعمل الآن!';

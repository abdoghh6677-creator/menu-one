-- =====================================================
-- إصلاح جميع الأعمدة المفقودة في جدول restaurants
-- Fix all missing columns in restaurants table
-- =====================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ تم إصلاح جميع الأعمدة المفقودة في جدول restaurants!';

...
/**
 * Format date and time in Egyptian timezone (Africa/Cairo)
 */
export const formatEgyptDateTime = (dateString: string | Date): string => {
  const date = new Date(dateString);
...
/**
 * Format date only in Egyptian timezone
 */
export const formatEgyptDate = (dateString: string | Date): string => {
  const date = new Date(dateString);
...
/**
 * Format time only in Egyptian timezone
 */
export const formatEgyptTime = (dateString: string | Date): string => {
  const date = new Date(dateString);
  return date.toLocaleString('ar-EG', {
    timeZone: 'Africa/Cairo',
    hour: '2-digit',

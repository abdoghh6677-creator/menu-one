...
const CustomerMenu: React.FC = () => {
  ...
  const categoriesList = ["all", ...(dbCategories.length > 0 ? dbCategories.map(c => lang === "ar" ? c.ar : (c.en || c.ar)) : [...new Set(menuItems.map((item) => getCategoryName(item, lang)).filter(Boolean))])];

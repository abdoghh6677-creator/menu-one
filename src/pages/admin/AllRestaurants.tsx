...
const AllRestaurants: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "blocked":
        return <Badge variant="error">محجوب</Badge>;
      case "trial":
  ...
  if (loading) {
    return <Loading text="جاري تحميل المطاعم..." />;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-text mb-2">جميع المطاعم</h2>
          <p className="text-text-secondary">
            إدارة جميع المطاعم المسجلة
          </p>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <Badge variant="success" className="text-lg px-4 py-2">
            {restaurants.filter((r) => r.status === "active").length} نشط
          </Badge>
        </div>
      </div>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            {restaurant.status === "active" ? (
              ...
              <Badge variant="error">محجوب</Badge>
            ) : (
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <InfoItem label="المالك Name" value={restaurant.owner_name} />
          <InfoItem
            label="Phone"
        ...
        {planConfig && (
          <div className="bg-bg-subtle rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-text-secondary">
                <strong className="text-text">الباقة:</strong> {planConfig.name}{" "}
        ...
        {/* سبب الحجب (if blocked) */}
        {restaurant.status === "blocked" && restaurant.block_reason && (
          <div className="bg-danger/10 border border-danger/20 rounded-lg p-4">
            <h4 className="font-semibold text-danger mb-2">سبب الحجب</h4>
            <p className="text-text-secondary text-sm">
...
const BlockModal: React.FC<BlockModalProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={isBlocked ? "إلغاء الحجب" : "حجب المطعم"}
      size="md"
    >
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            fullWidth
          >
            {isBlocked ? "إلغاء الحجب" : "حجب المطعم"}
          </Button>
        </div>
      </div>
    </Modal>

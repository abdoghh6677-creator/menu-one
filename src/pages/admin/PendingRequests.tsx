      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary">
            مراجعة واعتماد طلبات تسجيل المطاعم
          </p>
        </div>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  {(request.heard_from || request.notes) && (
                    <div className="bg-bg-subtle rounded-lg p-3 space-y-2 text-sm">
                      ...
                      {request.notes && (
                        <p className="text-text-secondary">
                          <strong className="text-text">ملاحظات:</strong>{" "}
                          {request.notes}
                        </p>
                      )}
                    </div>
...
const CreateAccountModal: React.FC<CreateAccountModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.email) {
      setError("البريد الإلكتروني is required");
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-bg-subtle rounded-lg p-4">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p className="text-text-secondary">
              <strong>المالك:</strong> {request.owner_name}
            </p>
            <p className="text-text-secondary">
        ...
        {/* Account Details */}
        <Input
          label="البريد الإلكتروني Address"
          type="email"
        ...
        <Textarea
          label="Internal ملاحظات (Optional)"
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                className="rounded border-border"
              />
              <span className="text-text">البريد الإلكتروني</span>
            </label>
          </div>
        </div>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-bg-subtle rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-2">
            <div>
              <label className="text-xs text-text-secondary">البريد الإلكتروني</label>
            ...
            <div>
              <label className="text-xs text-text-secondary">رابط الدخول</label>
        ...
        <Button
          ...
          onClick={handleCopy}
        >
          {copied ? "تم النسخ!" : "نسخ كل البيانات"}
        </Button>
        ...
        <div className="bg-accent-secondary/10 border border-accent-secondary/20 rounded-lg p-3 text-sm">
          ...
          <span className="text-text-secondary">
            ...
            selected channels (SMS/WhatsApp/البريد الإلكتروني).
          </span>
        </div>
